...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        if (Statement.exists(getConnection(),"contact_id = " + getContactId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: statement_contact_fk");
        }
