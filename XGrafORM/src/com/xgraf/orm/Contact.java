...
public class Contact extends DbObject  {
    ...
    public Contact(Connection connection) {
        ...
        setColumnNames(new String[]{"contact_id", "company_id", "name", "phone", "email", "email1", "comments"});
    }

    public Contact(Connection connection, Integer contactId, Integer companyId, String name, String phone, String email, String email1, String comments) {
        super(connection, "contact", "contact_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT contact_id,company_id,name,phone,email,email1,comments FROM contact WHERE contact_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO contact ("+(getContactId().intValue()!=0?"contact_id,":"")+"company_id,name,phone,email,email1,comments) values("+(getContactId().intValue()!=0?"?,":"")+"?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE contact " +
                    "SET company_id = ?, name = ?, phone = ?, email = ?, email1 = ?, comments = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT contact_id,company_id,name,phone,email,email1,comments FROM contact " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Contact(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7)));
                dbObj.setNew(false);
            }
        } finally {
            try {
