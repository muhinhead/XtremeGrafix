...
public class User extends DbObject  {
    ...
    public User(Connection connection) {
        ...
        setColumnNames(new String[]{"user_id", "first_name", "last_name", "initials", "login", "passwd", "is_admin"});
    }

    public User(Connection connection, Integer userId, String firstName, String lastName, String initials, String login, String passwd, Integer isAdmin) {
        super(connection, "user", "user_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT user_id,first_name,last_name,initials,login,passwd,is_admin FROM user WHERE user_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO user ("+(getUserId().intValue()!=0?"user_id,":"")+"first_name,last_name,initials,login,passwd,is_admin) values("+(getUserId().intValue()!=0?"?,":"")+"?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE user " +
                    "SET first_name = ?, last_name = ?, initials = ?, login = ?, passwd = ?, is_admin = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT user_id,first_name,last_name,initials,login,passwd,is_admin FROM user " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new User(con,new Integer(rs.getInt(1)),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),new Integer(rs.getInt(7))));
                dbObj.setNew(false);
            }
        } finally {
            try {
