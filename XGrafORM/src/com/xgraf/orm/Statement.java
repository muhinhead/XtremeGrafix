...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        {// delete cascade from statementitem
            Statementitem[] records = (Statementitem[])Statementitem.load(getConnection(),"statement_id = " + getStatementId(),null);
            for (int i = 0; i<records.length; i++) {
                Statementitem statementitem = records[i];
                statementitem.delete();
            }
        }
        PreparedStatement ps = null;
        String stmt =
