...
public class Statementitem extends DbObject  {
    ...
    public Statementitem(Connection connection) {
        ...
        setColumnNames(new String[]{"statementitem_id", "statement_id", "stitem_date", "stitem_ref", "descry", "amount", "payment", "balance"});
    }

    public Statementitem(Connection connection, Integer statementitemId, Integer statementId, Date stitemDate, String stitemRef, String descry, Double amount, Double payment, Double balance) {
        super(connection, "statementitem", "statementitem_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT statementitem_id,statement_id,stitem_date,stitem_ref,descry,amount,payment,balance FROM statementitem WHERE statementitem_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                statementitem.setDescry(rs.getString(5));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO statementitem ("+(getStatementitemId().intValue()!=0?"statementitem_id,":"")+"statement_id,stitem_date,stitem_ref,descry,amount,payment,balance) values("+(getStatementitemId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    ...
                    "SET statement_id = ?, stitem_date = ?, stitem_ref = ?, descry = ?, amount = ?, payment = ?, balance = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT statementitem_id,statement_id,stitem_date,stitem_ref,descry,amount,payment,balance FROM statementitem " +
    ...
    public void setDescry(String descry) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.descry != null && !this.descry.equals(descry));
        this.descry = descry;
    }
