...
//    protected JMenu filterMenu;
    ...
    public GeneralFrame(String title, IMessageSender exch) {
        ...
        this.exchanger = exch;
        fillContentPane();
        float width = Float.valueOf(XGrafWorks.readProperty("WindowWidth", "0.8"));
        float height = Float.valueOf(XGrafWorks.readProperty("WindowHeight", "0.8"));
...
//            selectedGridPanel.highlightSearch(srcField.getText());
    ...
    public void windowClosed(WindowEvent e) {
        ...
        XGrafWorks.getProperties().setProperty("WindowWidth", "" + xRatio);
        XGrafWorks.getProperties().setProperty("WindowHeight", "" + yRatio);
